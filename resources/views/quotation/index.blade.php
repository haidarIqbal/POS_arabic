		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" id="yoyo" role="form" method="POST" action="{{ url('store/'.$store.'/quotation') }}">
                        {!! csrf_field() !!}
						<div class="row">
							<div class="col-sm-4">
					...
					<div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title" id="myModalLabel">
                               <p dir="rtl">اسم الزبون:<strong> {{$user->name}}</strong></p>
                                 <p dir="rtl">هاتف العميل:<strong> {{$user->number}}</strong></p>
                               <p dir="rtl">هاتف العميل:  <strong>{{$user->location}}</strong></p>
                            </h5>
                        </div>                    
					<div class="modal-body" style="padding:5px !important">
						<div class="panel-body" id="toPrint"  style="padding:5px !important">
							<table class="table table-striped" >
								<thead>
									<tr>
										<th>اسم العنصر<br>Item Name</th>
